...
@media (-o-min-device-pixel-ratio: 5/4), (-webkit-min-device-pixel-ratio: 1.25), (min-resolution: 120dpi) {
    .icheckbox_square,
    .iradio_square {
        background-image: url(https://cdnjs.cloudflare.com/ajax/libs/iCheck/1.0.1/skins/square/green@2x.png);
...
.iradio_square-green {
    ...
    *display: inline;
    ...
    width: 22px;
    height: 22px;
    background: url('https://cdnjs.cloudflare.com/ajax/libs/iCheck/1.0.1/skins/square/green.png') no-repeat;
    border: none;
    cursor: pointer;
}
